...
const AgentsSection: React.FC = () => {
  ...
  return <section className="section-padding bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {agents.map((agent, index) => <div key={index} className="agent-card hover:scale-105 transition-all duration-300 animate-fade-up" style={{
