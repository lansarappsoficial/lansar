...
const BenefitsSection: React.FC = () => {
  const benefitPoints = ["Trabalham 24 horas por dia, 7 dias por semana", "Nunca esquecem um follow-up", "Não perdem leads", "Mantêm consistência total na abordagem", "E nunca pedem aumento de salário?"];
  const segments = ["Infoprodutores e lançadores digitais", "Prestadores de serviço de todos os portes", "Empresas de tecnologia e software", "Indústrias e fabricantes", "E-commerce e varejo digital", "Agências de marketing e consultorias", "Atacadistas e distribuidores", "E muitos outros segmentos que buscam escalar vendas com automação inteligente"];
  return <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16 animate-fade-in">
          ...
          <div className="mt-8 bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-lansar/10 shadow-lg animate-fade-up" style={{
          animationDelay: "0.2s"
        }}>
            ...
            <ul className="text-lg text-gray-700 list-none mb-6 space-y-2">
              {benefitPoints.map((point, index) => <li key={index} className="flex items-center animate-fade-up" style={{
            ...
            <p className="text-lg md:text-xl text-gray-700 animate-fade-up" style={{
            animationDelay: "0.8s"
          }}>
