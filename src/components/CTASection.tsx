        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button className={`cta-button text-lg hover:scale-105 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
