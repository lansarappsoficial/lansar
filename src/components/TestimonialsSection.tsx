      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Empresas de todos os portes estão transformando seus resultados com a Lansar
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button variant="default" size="lg" className="bg-lansar hover:bg-lansar-dark">
            Ver mais depoimentos <ArrowRight className="ml-2" />
          </Button>
        </div>
      </div>
    </section>
