...
const Header: React.FC = () => {
  ...
  return <header className={`relative z-50 transition-all duration-300 ${isScrolled ? "bg-white/95 backdrop-blur-sm shadow-sm py-3" : "bg-transparent py-5"} animate-fade-in`}>
